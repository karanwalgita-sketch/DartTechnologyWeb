  ...
  return (
    ...
    >
        ...
        <div className='flex flex-col-reverse md:flex-row justify-between gap-x-9 items-center '>
            ...
            A skilled cross-platform Mobile App Developer specializing in React Native, Native iOS (Swift), and Flutter, with hands-on experience building smooth, responsive, and performance-optimized applications. Focused on clean UI/UX, modern animations, scalable architecture, and delivering production-ready mobile apps for both iOS and Android.
                  </p>
                  {/* resume button*/}
                  <a 
            ...
            <img src={profile} alt='Devank karanwal'
